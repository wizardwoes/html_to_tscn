Get-ChildItem -Recurse -Path .\src_html\glas\* -Include index.html | ForEach-Object { 
    Write-Output & C:/Users/choosegoose/.virtualenvs/html_to_tscn-UVkTTcz6/Scripts/python.exe c:/code/html_to_tscn/page_content.py --src $_.FullName
}

# Get-ChildItem -Recurse -Path .\src_html\glas\page-28\* -Include index.html | ForEach-Object { 
#     Write-Output & C:/Users/choosegoose/.virtualenvs/html_to_tscn-UVkTTcz6/Scripts/python.exe c:/code/html_to_tscn/page_content.py --src $_.FullName
# }
